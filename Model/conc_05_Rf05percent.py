...
filename = '/home/groups/hilley/scdobbs_hilley_lem/lem_outputs/conc_05_Rf05percent_'
...
f_dzdt = build_model_dzdt((ny, nx), dx, l, L, Rf, time_to_steady_state, Pe, ka, h, m, hook = checkpointer, renoise = 1E-4, renoise_interval = 1000, scaling_factor = scaling_factor)
